...
(
    ...
    NULL,
    created_on TIMESTAMP WITHOUT TIME ZONE NOT NULL,
    CONSTRAINT UQ_REQUEST_USER UNIQUE ( event_id, requester_id ),
...
(
    ...
    CONSTRAINT FK_TO_MANY_COMPILATION FOREIGN KEY (compilation_id) REFERENCES compilations (id) ON DELETE CASCADE,
    CONSTRAINT FK_TO_MANY_EVENT FOREIGN KEY (event_id) REFERENCES events (id) ON DELETE CASCADE
);
